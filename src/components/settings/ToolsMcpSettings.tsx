  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2 p-3 border rounded-lg">
        <div className="text-sm font-medium">Importar/Exportar via JSON</div>
        <textarea
          className="w-full h-32 rounded-md border bg-transparent px-3 py-2 text-sm"
        ...
        <div className="flex gap-2">
          <Button
            onClick={async () => {
              try {
                const res = await importJson(importJsonText);
                showSuccess(`MCP importado em ${res.path}`);
                setImportJsonText("");
              } catch (e: any) {
          ...
          <Button
            ...
            onClick={async () => {
              try {
                ...
                showSuccess(`JSON copiado e salvo em ${res.path}`);
              } catch (e: any) {
                showError(e?.message || String(e));
              }
            }}
